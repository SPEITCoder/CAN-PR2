...
The two replacement policies with a higher data cache associativity have better performances than the original DIRECT\_MAPPED with the same total size in general.
